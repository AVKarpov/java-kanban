...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SubTask subTask3 = new SubTask("Epic #2 subTask #1","Epic #2 subTask #1 description","IN_PROGRESS", epic2Id);
        ...
        System.out.println("Статус задачи Task #1 до изменения: " + task_test.getStatus());
        task_test.setStatus("IN_PROGRESS");
        manager.updateTask(task_test);
        System.out.println("Изменили статус Task #1 NEW -> IN_PROGRESS..");
        System.out.println("Статус задачи Task #1 после изменения: " + task_test.getStatus() + "\n");

        System.out.println("ТЕСТ: удаление задачи Task #1");
        ...
        System.out.println("Статус эпика Epic #1: " + epic_test.getStatus());
        printEpicSubTasksStatus(manager, epic_test);
        subTask_test.setStatus("DONE");
        manager.updateSubTask(subTask_test);
        System.out.println("Изменили статус подзадачи Epic #1 subTask #2 NEW -> DONE");
        System.out.println("Статус эпика Epic #1: " + epic_test.getStatus());
        printEpicSubTasksStatus(manager, epic_test);
        System.out.println("");
        ...
        subTask_test.setStatus("DONE");
        manager.updateSubTask(subTask_test);
        System.out.println("Изменился статус подзадачи Epic #1 subTask #1 NEW -> DONE");
        System.out.println("Статус эпика Epic #1: " + epic_test.getStatus());
        printEpicSubTasksStatus(manager, epic_test);
        System.out.println("");
        ...
        System.out.println("Список эпиков после удаления Epic #2:");
        printAllEpics(manager);
        System.out.println("");
