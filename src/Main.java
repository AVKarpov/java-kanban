...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        manager.getTask(manager.addNewTask(new Task("Task #3","Task #3 description", IN_PROGRESS)));
        manager.getTask(manager.addNewTask(new Task("Task #4","Task #4 description", NEW)));

        printHistory(manager);
        manager.getEpic(manager.addNewEpic(new Epic("Epic #3","Epic #3 description", NEW)));
        manager.getEpic(manager.addNewEpic(new Epic("Epic #4","Epic #4 description", IN_PROGRESS)));
        printHistory(manager);
    }
